...
public class FileCompareUtil {
    public static void main(String[] args) throws Exception {
        String f1 = "src/com/kosta/day15/IO/first.txt";
        String f2 = "src/com/kosta/day15/IO/second.txt";
...
//-	첫번째 입력된 텍스트 파일 내용을 기준으로 두번째 입력된 텍스트 파일 태용을
// 라인별로 비교하고 동일할 경우 다음 라인으로 이동합니다. 다를 경우에는 해당
// 라인의 번호와 함께 두번째 파일의 해당 라인 내용을 결과 용도의 ArrayList에 추가합니다.
